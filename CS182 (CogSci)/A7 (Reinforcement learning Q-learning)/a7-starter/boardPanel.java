...
public class boardPanel extends JPanel {
    ...
    Vector<boardContainer> boardVec; // objects on board to paint, listed as
                                        // vector in order of painting
    ...
    public boardPanel(boardObject d, int x, int y, int w, int h) {
        ...
        boardVec = new Vector<boardContainer>(); // this instance will
                                                    // probably get replaced,
    ...
    public boolean setSquare(boardObject b, int x, int y) {
        ...
        if (USEVEC) {
            boardContainer thisSquare = new boardContainer(new Dimension(x, y),
                    b);
    ...
    public void clearBoard() {
        if (USEVEC)
            boardVec = new Vector<boardContainer>();
        else {
