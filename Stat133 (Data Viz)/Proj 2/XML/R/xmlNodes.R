...
if(!isGeneric("xmlAttrs<-"))
 setGeneric("xmlAttrs<-", function(node, value, suppressNamespaceWarning = getOption('suppressXMLNamespaceWarning', FALSE) )
                          standardGeneric("xmlAttrs<-"))

tmp =
function(node, value, suppressNamespaceWarning = getOption('suppressXMLNamespaceWarning', FALSE) )
{
