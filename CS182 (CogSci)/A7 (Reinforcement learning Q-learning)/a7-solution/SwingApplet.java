...
public class SwingApplet extends JApplet implements ActionListener,Runnable{
	...
	MonsterAndKnightWorld trainWorld, playWorld; // seperate world from playing world
	RLController rlc;
	RLearner rl;
...
/*		Image monsterImg = getImage(ClassLoader.getSystemResource("monster.gif"));
		Image knightImg = getImage(ClassLoader.getSystemResource("knight.gif"));
		Image wallImg = getImage(ClassLoader.getSystemResource("wall.gif"));
		Image treasureImg = getImage(ClassLoader.getSystemResource("treasure.gif"));*/
	...
	public void updateBoard() {
		...
		monsterscorelabel.setText(CS_TEXT+" "+Integer.toString(monsterscore));
		if (game.newInfo) {
			updateScore();
			game.newInfo = false;
		}
	...
	void updateScore() {
		double newScore = Math.round(1000*((double)knightscore)/(monsterscore + knightscore))/10;
