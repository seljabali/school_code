...
addLocation = function(masteR,datA){
B1=read.csv(paste(datA,"B1 cleaner.csv",sep = ""))
	library(XML)
	...
	gml.state.abbrev[[9]]="DC" #Washington DC didnt have an abbreviation!
	...
	gml.state.count=sapply(gml.state.count,function(L){xmlGetAttr(L[[1]],"abbreviation")})
