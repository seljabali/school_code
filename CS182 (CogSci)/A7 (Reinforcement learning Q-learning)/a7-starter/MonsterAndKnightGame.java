...
public class MonsterAndKnightGame extends Thread {
    ...
    public MonsterAndKnightGame(SwingApplet s, long delay,
            MonsterAndKnightWorld w, RLPolicy policy) {
        world = w;
    ...
    public Dimension getKnight() {
        return new Dimension(world.mx, world.my);
    }

    public Dimension getMonster() {
        return new Dimension(world.cx, world.cy);
    }

    public Dimension getTreasure() {
        return new Dimension(world.chx, world.chy);
    }
